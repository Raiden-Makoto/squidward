...
| ---- | -------------------- | --------- | -------- | --------- | ------------- | --------------------------------------- |
| 1    | MoE gemm2            | 45.6      | 30.9     | 14.7      | 2.3%          | Optional; config exhausted, kernel work |
| 2    | Absorbed K/V BMM     | 25.3      | 11.0     | 14.3      | 2.2%          | Kernel work                             |
