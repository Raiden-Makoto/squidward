...
class Envs:
    ...
    SGLANG_DEBUG_SPEC_PROBS_CAPTURE_DIR = EnvStr(None)
    SGLANG_DEBUG_SPEC_PROBS_CAPTURE_ARM_FILE = EnvStr(None)
    SGLANG_DEBUG_SPEC_PROBS_CAPTURE_MAX_ROWS = EnvInt(256)
