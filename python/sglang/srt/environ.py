...
class Envs:
    ...
    # when the current forward has at least
    # SGLANG_DSA_FP8_PROJ_HYBRID_SEQ_MIN sequences.
    ...
    # Inclusive per-forward sequence-count crossover for hybrid q_b_proj and
    # o_proj. The old M-based name remains as a deprecated alias.
    SGLANG_DSA_FP8_PROJ_HYBRID_SEQ_MIN = EnvIntWithAlias(
        16, deprecated_name="SGLANG_DSA_FP8_PROJ_HYBRID_M_MIN"
    )
